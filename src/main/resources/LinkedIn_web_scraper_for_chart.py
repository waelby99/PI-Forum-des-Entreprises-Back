...
def determine_speciality(title):
    ...
    keywords = {
        ...
        'DWM': ['validation','Validation','react native', 'ios', 'swift', 'kotlin', 'mobile', 'android', 'flutter','java', 'web', 'fullstack', 'full stack', 'node.js','node js', 'express js', '.net', 'angular', 'dotnet', 'vue js', 'react', 'html', 'css', 'javascript', 'springboot', 'frontend', 'front-end', 'backend', 'back-end', 'php', 'symfony', 'laravel', 'mobiles','mobile','wordpress','reactjs','nodejs'],
        # Dig data et bi
        'BI&BD': ['ERP','erp','data scientist','power bi', 'ssis', 'ssrs', 'ssas', 'business intelligence', 'big data', 'sql', 'administrateur', 'oracle','python', 'machine learning', 'science', 'r', 'scientist','talend','excel','data mining'],
        # Embarque
        'ES': ['automatisation','Cobol','ECU','ecu','AUTOMATED','Automated','automated','SYSTEMS','systems','Systems','Automation','Automobile','embarque','embedded','cad', 'c++', 'c', 'autocad','iot','embarques','Embarque','IoT','électroniques','électronique','electronique','C/C++','c/c++','internet','INTERNET','Internet'],
        # Cloud
        'CL': ['DevOps','linux', 'devops', 'ip', 'cloud', 'terraform', 'grafana', 'apache airflow', 'securite','security'],
    }
